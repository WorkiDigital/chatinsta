...
export default function CampaignBuilder({ mode, campaignId }: CampaignBuilderProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Top bar — sticky under the page header so Go Live / Save stays
          reachable on a form long enough to scroll past it. */}
      <div className="sticky top-0 z-20 -mx-4 -mt-5 flex flex-wrap items-center justify-between gap-x-4 gap-y-3 border-b border-border bg-background px-4 py-3 sm:-mt-6 lg:px-8">
